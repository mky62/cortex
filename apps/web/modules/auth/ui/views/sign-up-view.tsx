...
const capabilities = [
  {
    title: "Chat widget",
    description: "Install customer support anywhere",
  },
  {
  ...
  },
  {
    ...
    description: "Support customers by phone",
  },
];
        ...
        <section className="hidden min-h-0 flex-col justify-center gap-8 overflow-hidden lg:flex">
          <div className="max-w-3xl space-y-8">
            <AuthAmbientPanel
              ...
              title="Begin with quiet clarity."
              description="Set up the customer widget, connect knowledge, and give your team a softer way to resolve support."
